...
export const load: PageLoad = async ({ params, fetch }) => {
  ...
  const jsonFilePath = `${BASE_PATH}/data/front-end-developement-front-end-developer-getting_started_with_web_development.json`;
   const res = await fetch(jsonFilePath);     
    ...
    const lessonPath = `${BASE_PATH}/data/lessons/free/${params.id}.json`;
